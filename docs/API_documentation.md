...
<table>
  <tr><td>End Point</td><td>Description</td></tr>
  <tr><td>/v2/foreign</td><td>Only receive_tx is supported at the moment, but this is enough to accept sends from mwc713 and mwc-wallet. Recieve invoice (initiated slate) generate the send payload back. By default this feature disabled. Please check 'max_auto_accept_invoice' setting for more details.</td></tr>
