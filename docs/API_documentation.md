...
<table>
  ...
  <tr><td colspan=2><code># curl -u mwc http://localhost:13415/v1/owner/retrieve_txs</code></td></tr>
  <tr><td colspan=2><code>
...
<table>
  ...
  <tr><td colspan=2><code># curl -u mwc -d '{"method": "mwcmqs", "amount": 100000000, "minimum_confirmations": 1, "max_outputs": 10, "num_change_outputs": 1, "selection_strategy_is_use_all": true, "dest": "xmgEvZ4MCCGMJnRnNXKHBbHmSGWQchNr9uZpY5J1XXnsCFS45fsU"}' http://localhost:8889/v1/wallet/owner/issue_send_tx</code></td></tr>
